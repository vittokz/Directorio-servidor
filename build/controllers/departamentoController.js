...
class DepartamentosController {
    listDepartamentos(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const departamentos = yield database_1.default.query('SELECT * FROM dir_departamento order by nombre ASC');
    ...
    getDeparId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const departamento = yield database_1.default.query('SELECT * FROM dir_departamento where id = ?', [id]);
